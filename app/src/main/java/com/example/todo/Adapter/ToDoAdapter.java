...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.ViewHolder> {
    ...
    public ToDoAdapter(DataBaseHandler db, MainActivity activity) {
        ...
        this.databaseReference = FirebaseDatabase.getInstance().getReference("tasks");
    }
    ...
    public void deleteItem(int position) {
        ...
        databaseReference.child(item.getId()).removeValue(); // Now ID is a String
    ...
    private void updateTaskStatus(String taskId, int status) {
        databaseReference.child(taskId).child("status").setValue(status); // Firebase update
    }
